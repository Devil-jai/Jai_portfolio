    ...
    <>
      ...
      <div className="container Contact my-5 px-5" data-aos="fade-up">
        <form action="https://formspree.io/f/mvojljrz" method="POST">
          ...
          <div className="mb-3" data-aos="fade-up" data-aos-duration="3000">
            <input
              className="input w-100 px-3 py-2"
              name="name"
              type="text"
              placeholder="Name"
              autoComplete="off"
          ...
          <div className="mb-3" data-aos="fade-up" data-aos-duration="3000">
            <input
              className="input w-100 px-3 py-2 mb-2"
              name="email"
              type="email"
              placeholder="E-mail"
              autoComplete="off"
          ...
          <div className="mb-3" data-aos="fade-up" data-aos-duration="3000">
            <textarea
              name="message"
              className="input input_style w-100"
              cols="30"
              rows="10"
              autoComplete="off"
              placeholder="Message"
          ...
          <div className="mb-3" data-aos="fade-up" data-aos-duration="3000">
            <button type="submit" className="send_button mb-3">
              SEND
            </button>
          </div>
        </form>
